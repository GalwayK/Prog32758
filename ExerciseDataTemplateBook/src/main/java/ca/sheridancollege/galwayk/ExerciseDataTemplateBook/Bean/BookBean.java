package ca.sheridancollege.galwayk.ExerciseDataTemplateBook.Bean;

import java.io.Serializable;

import ca.sheridancollege.galwayk.ExerciseDataTemplateBook.Genres;
...
public class BookBean implements Serializable
{
    ...
    public String toString()
    {
        return String.format("Book: %d. %s by %s, a %s book", isbn, title, author, 
        	ca.sheridancollege.galwayk.ExerciseDataTemplateBook.Genres.values()[genre].getGenre());
    }
