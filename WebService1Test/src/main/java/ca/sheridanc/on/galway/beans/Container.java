package ca.sheridanc.on.galway.beans;
...
public class Container implements Comparable<Container>, Serializable {
     ...
     * volume.  ID can't be less than 0, name can't be empty 
     * and volume must be greater than 0.
     * 
     ...
     * id member.  The id can't be less than, otherwise an 
     * exception is thrown.
     * 
    ...
    public String toString() 
    {
        ...
        return String.format("%s: %.2f", containerName, volume);
    }
    /**
